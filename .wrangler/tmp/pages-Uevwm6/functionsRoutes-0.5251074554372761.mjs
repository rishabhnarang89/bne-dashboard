import { onRequest as __api_activity_ts_onRequest } from "/Volumes/MaxStore/02_Current_Projects/BNE KIT VALIDATION/bne-dashboard/functions/api/activity.ts"
...
export const routes = [
    {
      ...
      method: "",
      middlewares: [],
      modules: [__api_activity_ts_onRequest],
    },
  {
      routePath: "/api/goals",
      mountPath: "/api",
